...
import * as S from './TeacherProfile.styles';
...
export const TeacherProfile: React.FC<TeacherProfileProps> = ({ avatar, name, speciality }) => {
  ...
  return (
    <S.Profile>
      <BaseAvatar size="large" src={avatar} icon={<UserOutlined />} alt="Teacher avatar" shape="square" />
      <div>
        <S.Info>
