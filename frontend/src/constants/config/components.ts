...
export const components: Component[] = [
  {
    ...
    url: `/medical-dashboard/#math_physics`,
    categories: ['charts'],
    keywords: ['math_physics', 'charts', 'statistics'],
  },
  {
    name: 'Prog/Networks',
    title: 'medical-dashboard.prog_networks',
    url: `/medical-dashboard/#prog_networks`,
    categories: ['charts'],
    keywords: ['prog_networks', 'charts', 'statistics'],
  },
  {
    name: 'Lang/Culture',
    title: 'medical-dashboard.lang_culture',
    url: `/medical-dashboard/#lang_culture`,
    categories: ['charts'],
    keywords: ['lang_culture', 'charts', 'statistics'],
  },
  {
    name: 'Map',
    title: 'common.map',
    ...
    categories: ['maps'],
    keywords: ['maps', 'teacher', 'polyclinic'],
  },
  {
  ...
  },
  {
    ...
    url: `/medical-dashboard/#homework-types-popularity`,
    categories: ['charts'],
  ...
  },
  {
    ...
    url: `/medical-dashboard/#exam-plan`,
