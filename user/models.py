...
class User(AbstractUser):
    ...
    twitter = models.URLField(_("twitter url"), max_length=250)
    linkedin = models.URLField(_("linkedin url"), max_length=250)
    facebook = models.URLField(_("facebook url"), max_length=250)
    instagram = models.URLField(_("instagram url"), max_length=250)
    github = models.URLField(_("github url"), max_length=250)
